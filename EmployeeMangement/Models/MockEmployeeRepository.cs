...
namespace EmployeeMangement.Models
{
    public class MockEmployeeRepository : IEmployeeRepository
    {
        ...
        public MockEmployeeRepository()
        {
            ...
            {
                new Employee() {Id=1, Name = "Momo", Email = "momo@itay.com", Department ="Hr"},
                new Employee() {Id=2, Name = "Maya", Email = "maya@itay.com", Department ="IT"},
                new Employee() {Id=3, Name = "Omri", Email = "omri@itay.com", Department ="IT"}
            };
        }
